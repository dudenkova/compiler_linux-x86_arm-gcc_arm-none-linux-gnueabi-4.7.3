...
enum opt_code
{
  ...
  OPT_mandroid = 1000,                       /* -mandroid */
  OPT_mapcs = 1001,                          /* -mapcs */
  OPT_mapcs_float = 1002,                    /* -mapcs-float */
  OPT_mapcs_frame = 1003,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1004,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1005,              /* -mapcs-stack-check */
  OPT_march_ = 1006,                         /* -march= */
  OPT_marm = 1007,                           /* -marm */
  OPT_mbig_endian = 1008,                    /* -mbig-endian */
  OPT_mbionic = 1009,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1010,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1011,     /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 1012,      /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 1013,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1014,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1015,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1016,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1017, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1018, */                    /* -mfp=3 */
  OPT_mfpe = 1019,                           /* -mfpe */
  /* OPT_mfpe_2 = 1020, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1021, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1022,                          /* -mfpu= */
  OPT_mglibc = 1023,                         /* -mglibc */
  /* OPT_mhard_float = 1024, */              /* -mhard-float */
  OPT_mlittle_endian = 1025,                 /* -mlittle-endian */
  OPT_mlong_calls = 1026,                    /* -mlong-calls */
  OPT_mpic_register_ = 1027,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1028,            /* -mpoke-function-name */
  OPT_msched_prolog = 1029,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1030,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1031, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1032,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1033,                         /* -mthumb */
  OPT_mthumb_interwork = 1034,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1035,                  /* -mtls-dialect= */
  OPT_mtp_ = 1036,                           /* -mtp= */
  OPT_mtpcs_frame = 1037,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1038,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1039,                         /* -mtune= */
  OPT_muclibc = 1040,                        /* -muclibc */
  OPT_munaligned_access = 1041,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1042,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1043,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1044,              /* -mword-relocations */
  OPT_mwords_little_endian = 1045,           /* -mwords-little-endian */
  OPT_n = 1046,                              /* -n */
  ...
  OPT_profile = 1075,                        /* -profile */
  OPT_pthread = 1076,                        /* -pthread */
  OPT_quiet = 1077,                          /* -quiet */
  OPT_r = 1078,                              /* -r */
  OPT_rdynamic = 1079,                       /* -rdynamic */
  OPT_remap = 1080,                          /* -remap */
  OPT_s = 1081,                              /* -s */
  OPT_s_bc_abi = 1082,                       /* -s-bc-abi */
  OPT_save_temps = 1083,                     /* -save-temps */
  OPT_save_temps_ = 1084,                    /* -save-temps= */
  OPT_shared = 1085,                         /* -shared */
  OPT_shared_libgcc = 1086,                  /* -shared-libgcc */
  /* OPT_specs = 1087, */                    /* -specs */
  OPT_specs_ = 1088,                         /* -specs= */
  OPT_static = 1089,                         /* -static */
  OPT_static_libgcc = 1090,                  /* -static-libgcc */
  OPT_static_libgcj = 1091,                  /* -static-libgcj */
  OPT_static_libgfortran = 1092,             /* -static-libgfortran */
  OPT_static_libgo = 1093,                   /* -static-libgo */
  OPT_static_libstdc__ = 1094,               /* -static-libstdc++ */
  ...
  OPT_time = 1128,                           /* -time */
  OPT_time_ = 1129,                          /* -time= */
  OPT_tno_android_cc = 1130,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1131,                 /* -tno-android-ld */
